...
read_csv("morning_session/data/brauer_data.csv")
...
library(pxR)
my_px_object <- read.px("morning_session/data/EAA13.px")
...
write_csv(eaa13_df, "morning_session/data/clean_eaa13.csv")
