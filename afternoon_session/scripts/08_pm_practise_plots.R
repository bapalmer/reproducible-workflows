...
# Load the data
who_tb_data <- read_csv("afternoon_session/data/clean_who_tb_data.csv")

# or
clean_brauer_data <- read_csv("afternoon_session/data/clean_brauer_data.csv")
