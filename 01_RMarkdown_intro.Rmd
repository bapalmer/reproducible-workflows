...
### Statistical outputs
It's also possible to format the outputs of your statistcial test for quick reporting.
...
source("afternoon_session/scripts/04_pm_plots.R")
